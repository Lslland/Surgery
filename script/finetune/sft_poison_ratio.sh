...
for poison_ratio in "${POISON_RATIOS[@]}"; do
    ...
    poison_eval_out=data/poison/gsm8k/${path_after_slash}_sft_f_${poison_ratio}_${sample_num}
    acc_eval_out=data/gsm8k/${path_after_slash}_sft_f_${poison_ratio}_${sample_num}
